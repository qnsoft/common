...
// package qn_cache provides high performance and concurrent-safe in-memory cache for process.
package qn_cache
...
// GetVar retrieves and returns the value of <key> as qn_var.Var.
func GetVar(key interface{}) qn_var.Var {
