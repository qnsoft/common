...
// package qn_cmd provides console operations, like options/arguments reading and command running.
package qn_cmd
...
// GetOptVar returns the option value named <name> as qn_var.Var.
func GetOptVar(name string, def ...string) qn_var.Var {
	doInit()
	return qn_var.New(GetOpt(name, def...))
}
...
// GetArgVar returns the argument at <index> as qn_var.Var.
func GetArgVar(index int, def ...string) qn_var.Var {
	doInit()
	return qn_var.New(GetArg(index, def...))
}
