...
func TestNewSortedStrArrayFrom(t *testing.T) {
	qn_test.C(t, func(t *qn_test.T) {
		...
		s2 := qn_array.NewSortedStrArrayFrom(a1, false)
...
func TestSortedStrArray_PopLeft(t *testing.T) {
	...
	qn_test.C(t, func(t *qn_test.T) {
		array := qn_array.NewSortedStrArrayFrom(qn.SliceStr{"1", "2", "3"})
		v, ok := array.PopLeft()
		t.Assert(v, 1)
		t.Assert(ok, true)
...
func TestSortedStrArray_Sum(t *testing.T) {
	qn_test.C(t, func(t *qn_test.T) {
		...
		a2 := []string{"1", "2", "3", "4", "a"}
		array1 := qn_array.NewSortedStrArrayFrom(a1)
		array2 := qn_array.NewSortedStrArrayFrom(a2)
...
func TestSortedStrArray_FilterEmpty(t *testing.T) {
	qn_test.C(t, func(t *qn_test.T) {
		array := qn_array.NewSortedStrArrayFrom(qn.SliceStr{"", "1", "2", "0"})
		t.Assert(array.FilterEmpty(), qn.SliceStr{"0", "1", "2"})
	})
	qn_test.C(t, func(t *qn_test.T) {
		array := qn_array.NewSortedStrArrayFrom(qn.SliceStr{"1", "2"})
