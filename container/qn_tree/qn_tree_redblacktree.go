...
// GetVar returns a qn_var.Var with the value by given <key>.
// The returned qn_var.Var is un-concurrent safe.
func (tree *RedBlackTree) GetVar(key interface{}) qn_var.Var {
	return qn_var.New(tree.Get(key))
}

// GetVarOrSet returns a qn_var.Var with result from GetVarOrSet.
// The returned qn_var.Var is un-concurrent safe.
func (tree *RedBlackTree) GetVarOrSet(key interface{}, value interface{}) qn_var.Var {
	return qn_var.New(tree.GetOrSet(key, value))
}

// GetVarOrSetFunc returns a qn_var.Var with result from GetOrSetFunc.
// The returned qn_var.Var is un-concurrent safe.
func (tree *RedBlackTree) GetVarOrSetFunc(key interface{}, f func() interface{}) qn_var.Var {
	return qn_var.New(tree.GetOrSetFunc(key, f))
}

// GetVarOrSetFuncLock returns a qn_var.Var with result from GetOrSetFuncLock.
// The returned qn_var.Var is un-concurrent safe.
func (tree *RedBlackTree) GetVarOrSetFuncLock(key interface{}, f func() interface{}) qn_var.Var {
	return qn_var.New(tree.GetOrSetFuncLock(key, f))
}
