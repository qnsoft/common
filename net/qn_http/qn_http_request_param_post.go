...
// Deprecated.
func (r *Request) GetPostVar(key string, def ...interface{}) qn_var.Var {
	return qn_var.New(r.GetPost(key, def...))
}
...
//
// Deprecated.
func (r *Request) GetPostMapStrVar(kvMap ...map[string]interface{}) map[string]qn_var.Var {
	postMap := r.GetPostMap(kvMap...)
	if len(postMap) > 0 {
