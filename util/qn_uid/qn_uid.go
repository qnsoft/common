...
// package qn_uid provides simple and high performance unique id generation functionality.
//
// PLEASE VERY NOTE:
...
var (
	sequence      qn_type.Uint32                           // Sequence for unique purpose of current process.
