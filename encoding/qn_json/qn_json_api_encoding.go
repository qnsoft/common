...
func (j *Json) ToXml(rootTag ...string) ([]byte, error) {
	return qn_xml.Encode(j.ToMap(), rootTag...)
}
...
func (j *Json) ToXmlIndent(rootTag ...string) ([]byte, error) {
	return qn_xml.EncodeWithIndent(j.ToMap(), rootTag...)
}
...
func (j *Json) ToIni() ([]byte, error) {
	j.mu.RLock()
	defer j.mu.RUnlock()
	return qn_int.Encode((*(j.p)).(map[string]interface{}))
}
